return {
  ...
  },
  {
    ...
    config = function()
      require("toggleterm").setup({
        ...
        highlights = { Normal = { guibg = "#1a1a1a" }, NormalFloat = { guibg = "#1a1a1a" }, FloatBorder = { guifg = "#4d4d4d", guibg = "#1a1a1a" } },
  ...
  },
  {
    ...
    event = { "BufReadPost", "BufNewFile" },
    config = function()
      require("colorizer").setup({ "*" }, { RGB = true, RRGGBB = true, names = false, RRGGBBAA = true, css = true, css_fn = true })
    end,
  },
  {
    ...
    event = "InsertEnter",
    config = function()
      require("better_escape").setup({ timeout = 200, mappings = { i = { j = { k = "<Esc>" } } } })
    end,
  },
  {
  ...
  },
  {
    ...
    config = function()
      require("todo-comments").setup({ colors = { error = { "#fb4934" }, warning = { "#fabd2f" }, info = { "#83a598" }, hint = { "#8ec07c" }, default = { "#d3869b" } } })
    end,
  },
}
