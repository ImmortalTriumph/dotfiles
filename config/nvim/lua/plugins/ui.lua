return {
        ...
        renderer = {
          ...
          icons = {
            glyphs = {
              ...
              git = { unstaged = "", staged = "", unmerged = "", renamed = "", deleted = "", untracked = "", ignored = "" },
            },
          },
        },
  ...
  },
  {
    ...
    config = function()
      local colors = {
        bg = "#1a1a1a", fg = "#d9d9d9", gray = "#808080", accent = "#b3b3b3",
        red = "#fb4934", green = "#b8bb26", yellow = "#fabd2f", blue = "#83a598",
        purple = "#d3869b", cyan = "#8ec07c", orange = "#fe8019",
      }

      local theme = {
        normal = { a = { fg = colors.bg, bg = colors.accent, gui = "bold" }, b = { fg = colors.fg, bg = colors.bg }, c = { fg = colors.gray, bg = colors.bg } },
    ...
    config = function()
      require("bufferline").setup({
        options = {
          ...
          offsets = { { filetype = "NvimTree", text = "Files", highlight = "Directory", separator = true } },
  ...
  },
  {
    ...
    config = function()
      require("ibl").setup({
        ...
        exclude = { filetypes = { "help", "alpha", "dashboard", "NvimTree", "lazy", "mason" } },
      })
    end,
  },
  {
    ...
    event = "VeryLazy",
    config = function()
      require("which-key").setup({ plugins = { marks = true, registers = true, spelling = { enabled = false } }, win = { border = "rounded" } })
  ...
  },
  {
    ...
    config = function()
      require("notify").setup({ background_colour = "#1a1a1a", timeout = 3000, max_width = 60, render = "minimal", stages = "fade" })
      require("noice").setup({
